<script lang="ts">
    ...
    import { PlusIcon, EditIcon, LinkIcon } from 'lucide-svelte';
    import { cn } from '$lib/utils';
    import { channelSchema } from '$lib/schema/channelSchema';
...
<Dialog.Root bind:open>
    <Dialog.Trigger 
        class={cn(
            buttonVariants({ size: 'sm', variant: isEditing ? 'ghost' : 'outline' }), 
